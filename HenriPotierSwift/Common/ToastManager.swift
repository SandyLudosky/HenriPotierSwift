...
extension UIView {
    ...
    func makeToast(message msg: String) {
        self.makeToast(message: msg, duration: HRToastDefaultDuration, position: .bottom)
    }
    func makeToast(message msg: String, duration: Double, position: Position) {
        let toast = self.viewForMessage(msg: msg, title: nil, image: nil)
        self.showToast(toast: toast!, duration: duration, position: position)
    }
    func makeToast(message msg: String, duration: Double, position: Position, title: String) {
        let toast = self.viewForMessage(msg: msg, title: title, image: nil)
        self.showToast(toast: toast!, duration: duration, position: position)
    }
    func makeToast(message msg: String, duration: Double, position: Position, image: UIImage) {
        let toast = self.viewForMessage(msg: msg, title: nil, image: image)
        self.showToast(toast: toast!, duration: duration, position: position)
    }
    func makeToast(message msg: String, duration: Double, position: Position, title: String, image: UIImage) {
